...
- 时间轴内每个时间段都包含 9 项：本段景别、本段运镜状态、焦点变化、核心动作、表情肢体联动、人物面光/骨骼光影、环境光影变化、环境细节补充、本段景深变化。
- 不能只在单独的"镜头语言与摄影参数"段落里写运镜、景别或焦点。
- 不能只在单独的"灯光、场景与动态"段落里写光线和场景。
- "镜头目标、整体风格、情绪基调"应合并成整体目标与风格基调。
- 如果时间轴段落缺少 9 项中任一项（景别/运镜/焦点/动作/表情肢体/面光骨骼光影/环境光影/环境细节/景深），该测试视为不通过。
...
- 时间轴每一段都必须按 9 项格式写明：本段景别、本段运镜状态、焦点变化、核心动作、表情肢体联动、人物面光/骨骼光影、环境光影变化、环境细节补充、本段景深变化。
...
- 应指出问题：主体不明确、场景缺失、动作缺失、时间轴缺失、时间轴内 9 项要素缺失。
- 应给出优化方向。
- 如果生成改写版，应补齐主体、场景、动作、时间轴 9 项要素（景别/运镜/焦点/动作/表情肢体/面光骨骼光影/环境光影/环境细节/景深）和禁止项。
...
- 时间轴应逐段按 9 项格式写明产品如何被拍摄：本段景别、本段运镜状态、焦点变化（锁定瓶身/瓶盖/反光/品牌区域）、核心动作、面光/骨骼光影、环境光影变化（台面反光、背景明暗）、环境细节补充、本段景深变化。
...
- 输出应包含镜头之间的连续性要求。
- 如果直接给分镜草案，每个分镜的时间轴都必须包含 9 项：本段景别、本段运镜状态、焦点变化、核心动作、表情肢体联动、人物面光/骨骼光影、环境光影变化、环境细节补充、本段景深变化。

...
- Rules: `reference-isolation-rules.md` — isolation and attribution rules for reference materials
- Rules: `reference-material-guide.md` — reference material usage guidelines
